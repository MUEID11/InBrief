...
const Contact = () => {
  ...
  return (
    <div>
      <div className=" pt-5">
        <h1 className="lg:text-4xl text-2xl text-center mb-6 font-bold text-Black">
        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-white dark:text-gray-800">
          <div className="flex flex-col justify-between">
            <div className="space-y-2">
              ...
              <div className="dark:text-gray-600 text-black text-xl">
                We want to here from you
              </div>
              <img
                src="https://res.cloudinary.com/duiymk5mu/image/upload/v1730444023/contact_us_jkhxsz.gif"
                alt=""
                loading="lazy"
                className="px-6  "
              />
          ...
          <form onSubmit={handleSubmit} noValidate="" className="space-y-6">
            ...
            <button
              type="submit"
              className="self-center bg-gradient-to-r from-red-500 to-red-600 text-white px-8 py-3 text-lg rounded-sm "
            >
              {" "}
              Send Massage
            </button>
