  ...
  return (
    <div>
      ...
      <div className="p-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* 1st card */}
        <div className="min-h-36 bg-gradient-to-r from-slate-300 to-slate-50 border flex  gap-2 p-4 relative">
          ...
          <div className=" ">
            ...
            <p className="text-xl font-medium absolute right-1 bottom-1 text-blue-700 hover:underline cursor-pointer">
              click here
            </p></Link>
          </div>
        </div>
