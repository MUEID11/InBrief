...
console.log(articles)
    return (
        <div>
          ...
          <div>
            Articles Posted By this
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 px-8">
            {articles.length > 0 ? articles.map((article) => <NewsCard key={article._id} article={article} />) : <p className="text-xl text-red-600">No Articles posted by this user yet</p>}
