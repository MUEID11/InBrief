        ...
        <main>
          <Marquee pauseOnHover={true}>
            {sponsorData.map((data) => (
              ...
              >
                <Link to={data.link}>
                  <div className="bg-gradient-to-b from-red-600 via-[#ea510e] to-[#ef7d00] border-5 border-red-600 rounded-full w-28 h-28 flex items-center justify-center p-[3px]">
