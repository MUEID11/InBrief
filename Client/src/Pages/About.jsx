  ...
  return (
    <div className="max-sm:px-2 container mx-auto px-3">
      ...
      <section className="text-center max-w-[800px] mx-auto my-10 text-stone-900">
        <h1 data-aos="fade" data-aos-duration="2000" className="font-bold text-3xl md:text-4xl lg:text-5xl font-inter">
          ABOUT US
        </h1>
        <p data-aos="fade" data-aos-duration="2000" className="text-stone-500 font-medium mt-3 text-lg max-sm:text-base leading-tight font-serif">
          InBrief is a personalized news platform that curates top stories from reliable sources, offering users a streamlined, customizable news experience
        </p>
      </section>

      {/* MIDDLE TWO IMAGES */}
      <section data-aos="fade" data-aos-duration="2000" className="flex gap-4 h-96 w-full max-sm:flex-col">
      ...
      <section data-aos="fade" data-aos-duration="2000" className="flex gap-20 max-sm:gap-5 mt-16 max-sm:flex-col ">
        <div className="md:w-1/3 flex gap-6 max-sm:gap-2 items-start">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-inter font-semibold uppercase">Our Story</h2>

          <img src={arrow} className="w-[24px] md:w-[30px]  lg:w-[40px] max-sm:w-11 rotate-90" alt="" />
        </div>
        <div className="md:w-2/3 ">
          <p className="mb-12 max-sm:mb-8 font-semibold ">
            InBrief was born from a desire to make news consumption more streamlined and meaningful. In a world filled with overwhelming information, we saw the need for a platform
            that curates the most relevant and trustworthy news from various sources, all in one place. Our mission is to empower readers by offering personalized news feeds,
            allowing them to stay informed while filtering out the noise.
          </p>
          <p className="text-stone-600">
            What started as a small project among like-minded individuals passionate about technology and current affairs has evolved into a comprehensive platform with features
            like customizable news categories, trending topics, and community engagement. At InBrief, we believe in the power of information and the need for users to take control
            of what they consume. With a strong emphasis on simplicity, reliability, and user experience, we are redefining how people interact with the news.
            <br />
            Whether you’re looking for the latest global headlines, in-depth analysis, or niche topics, InBrief brings everything to your fingertips. Our journey is just beginning,
            and we are excited to continue innovating, always striving to deliver a better experience for our users.
            <br />
          </p>
        </div>
      </section>
      ...
      {/* OUR SPONSORS SLIDER */}
      <section className="mt-28" data-aos="fade" data-aos-duration="2000">
        <header className="mb-14">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-inter font-semibold uppercase">Our Sponsors</h3>
        </header>
        <main>
          <Marquee pauseOnHover={true}>
            {sponsorData.map((data) => (
              <div key={data.id} className="flex flex-col items-center justify-center mr-12">
                ...
                <Link to={data.link}>
                  <p className="text-xl font-semibold text-neutral-600 mt-3">{data.name}</p>
                </Link>
              </div>
            ))}
          </Marquee>
      ...
      {/* Our team */}
      <section>
        <header className="mt-16 mb-5" data-aos="fade" data-aos-duration="2000">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-inter text-center mb-3 font-semibold uppercase">Our Team</h3>
          <p className="text-center px-4 text-neutral-600">
      ...
      {/* Join With us  */}
      <section data-aos="fade" data-aos-duration="1000" className="mt-28 flex max-sm:flex-col gap-10 items-center justify-center">
        <div className="w-1/2 max-sm:w-full">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium uppercase">Join with Us</h2>
          <p className="mt-5 text-stone-600 max-w-[500px] font-medium">
            Join us at InBrief, where news isn't just gathered—it's tailored for you. We’re creating a platform that brings together the latest, most relevant stories from trusted
            sources, ensuring you stay informed and engaged. Be a part of our community and experience news that fits your world."
            <br />
            <br />
            Together, let's reshape how news is discovered, shared, and discussed in a way that connects us all.
          </p>
          <Link to="/signup">
