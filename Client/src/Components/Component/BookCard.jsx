...
const BookCard = ({ book }) => {
  ...
  return (
    <div className="p-3 border border-[#13131326] rounded-2xl font-workSans cursor-pointer">
      <Link to={`/books/${bookId}`} className=" h-full flex flex-col">
        <div className="flex-1">
          ...
          <h4 className=" text-neutral-600 font-medium mb-5 whitespace-pre-wrap">By: {author}</h4>
        </div>
