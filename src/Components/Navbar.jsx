...
const Navbar = () => {
    ...
    return (
      ...
      <div className="container mx-auto flex justify-between items-center py-3 sm:py-5">
        ...
        <a href="/">In<span className='text-2xl'>Brief</span></a>
        </div>
        ...
        <div className="hidden  sm:flex space-x-3 sm:space-x-5 mr-0 sm:mr-40  bg-gradient-to-r from-purple-800 via-pink-700 to-blue-800 bg-clip-text text-transparent">
          <a href="/home" className="hover:text-gray-400">Stories</a>
          <a href="/world" className="hover:text-gray-400">Creator</a>
          <a href="/politics" className="hover:text-gray-400">Community</a>
          <a href="/sports" className="hover:text-gray-400">Subscribe</a>
        </div>
      ...
      <div className={`sm:hidden ${isOpen ? 'block' : 'hidden'}`}>
        <div className="px-4 pb-4 space-y-2">
          <a href="/home" className="block text-lg py-2 hover:text-gray-400">Stories</a>
          <a href="/world" className="block text-lg py-2 hover:text-gray-400">Creator</a>
          <a href="/politics" className="block text-lg py-2 hover:text-gray-400">Community</a>
          <a href="/sports" className="block text-lg py-2 hover:text-gray-400">Subscribe</a>
