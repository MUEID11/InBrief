const Newsletter = () => {
  return (
    <section className="sm:m-0 m-2">
      <div className="bg-red-200 container mx-auto rounded-lg sm:p-10 p-4 mt-12 flex flex-col md:flex-row items-center justify-between gap-4 ">
        ...
        <div className="w-full text-center md:w-1/2 ">
          <input
            type="text"
            className="text-lg bg-white text-black p-2 rounded-lg "
          />
